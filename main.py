...
def get_args():
    ...
    parser.add_argument('--cutoff', type=float, default=100.0, help='the top percentage of node neighbors to search for counterfactual pairs')
    ...
    parser.add_argument('--gnn_type', type=str, default='GAT',choices=['SAGE','GCN', 'GAT'])
